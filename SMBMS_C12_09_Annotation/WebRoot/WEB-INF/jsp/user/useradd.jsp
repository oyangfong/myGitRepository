...
<div class="right content">
	...
	<div class="providerAdd">
		<%--ch11 文件上传表单的编码类型必须是"multipart/form-data"--%>
		<form id="userForm" name="userForm" method="post"
			...
			<!-- ch11-文件上传  CommonsMultipartResolver(spring3.0以前的版本)-->
           <div>
                <input type="hidden" id="errorinfo" value="${uploadFileError}"/>
				<label for="a_idPicPath">证件照：</label> 
				<input name="a_idPicPath"  id="a_idPicPath" type="file">
			</div>
		    <!-- /ch11-文件上传 -->
		    
		    <!-- attach-文件上传  StandardServletMultipartResolver (spring3.1及以后的版本)-->
           <div>
                <input type="hidden" id="errorinfo" value="${uploadFileError}"/>
				<label for="a_workIdPicPath">工作证：</label> 
				<input name="a_workIdPicPath"  id="a_workIdPicPath" type="file" accept="image/jpg,image/jpeg,image/png,image/gif">
			</div>
		    <!-- /attach-文件上传 -->
