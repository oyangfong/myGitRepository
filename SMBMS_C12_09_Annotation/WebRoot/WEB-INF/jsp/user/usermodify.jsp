...
<%@include file="/WEB-INF/jsp/common/head.jsp"%>
    <div class="right content">
        ...
        <form id="userForm" name="userForm" method="post" action="${pageContext.request.contextPath }/sys/user/domodify.html">
...
<script type="text/javascript" src="${pageContext.request.contextPath }/statics/js/getrolelist.js"></script>
