...
<div class="right content">
	...
	<div class="search">
		<form method="get"
			...
			</select> <input type="hidden" name="currentPageNo" value="1" /> <input
				value="查 询" type="submit" id="searchbutton"> <a
				href="${pageContext.request.contextPath}/sys/user/add">添加用户</a>
		</form>
	</div>
	<div>
	<!--用户-->
	...
	<%--ch12 增加一个div区域用于显示用户的明细信息--%>

<div class="providerAdd userdetail">
	<div>
